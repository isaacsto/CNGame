...
function openCrawlSpace() {
    ...
    const imageUrls = [
        ...
        "/CNProjects/CNGame/assets/crawl-space-repair-after.jpg", 
    ];
    currentImageIndex = 0; 
...
function openFoundation() {
    ...
    const imageUrls = [
        ...
        "/CNProjects/CNGame/assets/foundation-repair-after.jpeg", 
    ];
    currentImageIndex = 0; 
...
function openAir() {
    ...
    const imageUrls = [
        ...
        "/CNProjects/CNGame/assets/aspen-sedona-house.jpg", 
    ];
    currentImageIndex = 0; 
